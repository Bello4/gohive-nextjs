...
// Types
import { CountryWithShippingRatesType } from "@/types/country";
...
export const columns: ColumnDef<CountryWithShippingRatesType>[] = [
  ...
  },
  {
    ...
    header: "Delivery Fee for additional item",
    cell: ({ row }) => {
