...
// Types
import { StoreDefaultShippingType } from "@/types/store";
  ...
  return (
    <AlertDialog>
      <Card className="w-full">
        <CardHeader>
          <CardTitle>Store Default Delivery details</CardTitle>
        </CardHeader>
        <CardContent>
          <Form {...form}>
            <form
            ...
            >
              <FormField
                ...
                render={({ field }) => (
                  <FormItem className="flex-1">
                    <FormLabel>Delivery Service name</FormLabel>
                    <FormControl>
              ...
              <div className="flex flex-wrap gap-4">
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className="flex-1">
                      <FormLabel>Delivery fee per item</FormLabel>
                      <FormControl>
                        <NumberInput
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className="flex-1">
                      <FormLabel>Delivery fee for additional item</FormLabel>
                      <FormControl>
                        <NumberInput
                          defaultValue={field.value}
                          onValueChange={field.onChange}
              ...
              <div className="flex flex-wrap gap-4">
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className="flex-1">
                      <FormLabel>Delivery fee per kg</FormLabel>
                      <FormControl>
                        <NumberInput
                          defaultValue={field.value}
                          onValueChange={field.onChange}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className="flex-1">
                      <FormLabel>Fixed Delivery fee</FormLabel>
                      <FormControl>
                        <NumberInput
                          defaultValue={field.value}
                          onValueChange={field.onChange}
